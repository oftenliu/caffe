 ...
 * input to a MTCNNEuclideanLossLayer exactly formulates a linear least squares
...
class OftenMtcnnEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit OftenMtcnnEuclideanLossLayer(const LayerParameter& param)
 ...
 protected:
   ...
   *
   * Unlike other children of LossLayer, MTCNNEuclideanLossLayer \b can compute
