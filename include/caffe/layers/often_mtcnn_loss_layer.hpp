#ifndef CAFFE_OFTEN_MTCNN_LOSS_LAYER_HPP_
#define CAFFE_OFTEN_MTCNN_LOSS_LAYER_HPP_
...
class OftenMtcnnLossLayer : public Layer<Dtype> {
 public:
  explicit OftenMtcnnLossLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
